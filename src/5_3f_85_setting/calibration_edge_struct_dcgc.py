...
if __name__ == '__main__':
    ...
    delete_record_dcgc = {'ece':[], 'acc':[], 'conf':[]}
    delete_record_cal = {'ece':[], 'acc':[], 'conf':[]}
    delete_record_cal_dcgc = {'ece':[], 'acc':[], 'conf':[]}

    add_record_uncal = {'ece':[], 'acc':[], 'conf':[]}
    add_record_dcgc = {'ece':[], 'acc':[], 'conf':[]}
    add_record_cal = {'ece':[], 'acc':[], 'conf':[]}
    add_record_cal_dcgc = {'ece':[], 'acc':[], 'conf':[]}
    ...
    if args.is_edge_delete:
        for delete_ratio in delete_ratio_list:
            ...
            for metric in de_record.keys():
                ...
                delete_record_dcgc[metric].append(de_record[metric][1])
                delete_record_cal[metric].append(de_record[metric][2])
                delete_record_cal_dcgc[metric].append(de_record[metric][3])
            
        print('----------------------------------------------------------------------------')
        print(f'delete edge mean ece uncal : {delete_record_uncal["ece"]}')
        print(f'delete edge mean ece DCGC  : {delete_record_dcgc["ece"]}')
        print(f'delete edge mean ece {args.calibration} : {delete_record_cal["ece"]}')
        print(f'delete edge mean ece DCGC+{args.calibration} : {delete_record_cal_dcgc["ece"]}')
        print()
        print(f'delete edge mean acc uncal : {delete_record_uncal["acc"]}')
        print(f'delete edge mean acc DCGC  : {delete_record_dcgc["acc"]}')
        print(f'delete edge mean acc {args.calibration} : {delete_record_cal["acc"]}')
        print(f'delete edge mean acc DCGC+{args.calibration} : {delete_record_cal_dcgc["acc"]}')
        print()
        print(f'delete edge mean conf uncal : {delete_record_uncal["conf"]}')
        print(f'delete edge mean conf DCGC  : {delete_record_dcgc["conf"]}')
        print(f'delete edge mean conf {args.calibration} : {delete_record_cal["conf"]}')
        print(f'delete edge mean conf DCGC+{args.calibration} : {delete_record_cal_dcgc["conf"]}')
        print('----------------------------------------------------------------------------')
        ...
        for add_num in add_num_list:
            ...
            for metric in add_record.keys():
                ...
                add_record_dcgc[metric].append(add_record[metric][1])
                add_record_cal[metric].append(add_record[metric][2])
                add_record_cal_dcgc[metric].append(add_record[metric][3])
        
        print('----------------------------------------------------------------------------')
        print(f'add edge mean ece uncal : {add_record_uncal["ece"]}')
        print(f'add edge mean ece DCGC  : {add_record_dcgc["ece"]}')
        print(f'add edge mean ece {args.calibration} : {add_record_cal["ece"]}')
        print(f'add edge mean ece DCGC+{args.calibration} : {add_record_cal_dcgc["ece"]}')
        print()
        print(f'add edge mean acc uncal : {add_record_uncal["acc"]}')
        print(f'add edge mean acc DCGC  : {add_record_dcgc["acc"]}')
        print(f'add edge mean acc {args.calibration} : {add_record_cal["acc"]}')
        print(f'add edge mean acc DCGC+{args.calibration} : {add_record_cal_dcgc["acc"]}')
        print()
        print(f'add edge mean conf uncal : {add_record_uncal["conf"]}')
        print(f'add edge mean conf DCGC  : {add_record_dcgc["conf"]}')
        print(f'add edge mean conf {args.calibration} : {add_record_cal["conf"]}')
        print(f'add edge mean conf DCGC+{args.calibration} : {add_record_cal_dcgc["conf"]}')
        print('----------------------------------------------------------------------------')
